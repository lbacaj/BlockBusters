import { NearestFilter, Vector4, TempNode, NodeUpdateType, PassNode } from '/js/three.webgpu.js';
import { nodeObject, Fn, float, uv, uniform, convertToTexture, vec2, vec3, clamp, floor, dot, smoothstep, If, sign, step, mrt, output, normalView, property } from '/js/three.tsl.js';
